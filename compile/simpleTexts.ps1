...
divine -a convert-loca -g bg3 -s "$absPath/$modName/Localization/English/AutosortContainers.xml" -d "$absPath/$modName/Localization/English/AutosortContainers.loca";
